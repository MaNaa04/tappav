...
import { Search, ShoppingCart, User, Monitor, Speaker, Home, Cable, ChevronRight, Menu, X } from 'lucide-react';
  ...
  return (
    <>
      <motion.nav
        ...
        className="bg-[#0066CC] text-white px-4 sm:px-6 py-4"
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <motion.button
              className="hidden sm:block bg-[#FFD700] text-black px-4 sm:px-6 py-2 rounded-full text-sm font-medium hover:bg-[#FFC700] transition-colors"
              style={{ fontFamily: 'Lora, serif' }}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
            >
            ...
            {/* User Icon — Desktop */}
            <motion.button className="hidden sm:block" whileHover={{ scale: 1.1 }}>
              <User size={20} />
            </motion.button>
          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                width: '85%',
                maxWidth: '380px',
                background: 'linear-gradient(180deg, #0a1628, #0d2145)',
                zIndex: 999,
                overflowY: 'auto',
            ...
            >
              ...
              <div style={{
                ...
                <div
                  style={{ fontFamily: 'Gloock, serif', fontSize: '22px', color: '#fff', cursor: 'pointer' }}
                  onClick={() => handleNavigate('/')}
                >
                  Tapp<span style={{ fontWeight: 700 }}>AV</span>
                </div>
                <motion.button
                  whileTap={{ scale: 0.9 }}
                  onClick={() => setMobileMenuOpen(false)}
                      ...
                      {item.hasDropdown && (
                        <ChevronRight
                          ...
                          style={{
                            ...
                            transform: item.isMega && mobileStoreExpanded ? 'rotate(90deg)' : 'rotate(0)',
                          }}
                        />
                      )}
                    </motion.button>

                    {/* Store Categories — Expandable */}
                    {item.isMega && (
                      <AnimatePresence>
                        {mobileStoreExpanded && (
                          <motion.div
                              ...
                              return (
                                ...
                                >
                                  <div style={{
                                    ...
                                    <IconComponent size={20} style={{ color: '#FFD700' }} />
                                  </div>
                                  <div>
                                    <div style={{ fontWeight: 500, marginBottom: '2px' }}>{cat.label}</div>
                                    <div style={{ fontSize: '12px', color: '#94a3b8' }}>{cat.description}</div>
                                  </div>
